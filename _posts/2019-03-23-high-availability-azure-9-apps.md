...
summary: We'll peek into the high availability options for Azure app service and Azure function apps.
...
2. Use [Azure Traffic Manager](../../../../2019/03/16/high-availability-azure-8-traffic) to route traffic to all available redundancies (you can only specify one App Service endpoint per region in a Traffic Manager profile). [More details here](https://docs.microsoft.com/en-us/azure/app-service/web-sites-traffic-manager#app-service-and-traffic-manager-profiles).
